...
Generative Adversarial Networks (GANs) are the networks that consist of two parts, Generator and Discriminator. The Generator is a model that maps the input noise to a sample. (e.g, random noise to a photo) And the discriminator model receives some samples as an input. The discriminator should output if the inputs are from the real data or they are generated by the generator? [Heaton, 2018](#ref)
...
<img width="300" height="200" src="https://render.githubusercontent.com/render/math?math=New Loss \downarrow = \frac{1}{Mean Square Error \uparrow}">
